...
<head>
    <title>Einloggen | Employee manager system</title>
    <meta charset="UTF-8">
            ...
            <div class="wrap-login100">
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Please enter password">
                        <input class="input100" type="password" name="frm[password]" placeholder="Passwort">
                        <span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="container-login100-form-btn">
                        <input type="submit" value="Einloggen" class="login100-form-btn" name="login_btn">
                    </div>
